...
function updateWorkingHoursStatus() {
    ...
    const workingHours = {
        0: currentHour >= 10 && currentHour < 22 ? 'Open until 22:00' : 'Closed, Open at 10:00', // Sunday
        1: currentHour >= 10 && currentHour < 22 ? 'Open until 22:00' : 'Closed, Open at 10:00', // Monday
        2: currentHour >= 10 && currentHour < 22 ? 'Open until 22:00' : 'Closed, Open at 10:00', // Tuesday
        3: currentHour >= 10 && currentHour < 22 ? 'Open until 22:00' : 'Closed, Open at 10:00', // Wednesday
        4: currentHour >= 10 && currentHour < 22 ? 'Open until 22:00' : 'Closed, Open at 10:00', // Thursday
        5: currentHour >= 15 && currentHour < 22 ? 'Open until 22:00' : 'Closed, Open at 15:00', // Friday
        6: currentHour >= 10 && currentHour < 22 ? 'Open until 22:00' : 'Closed, Open at 10:00', // Saturday
    };
    ...
    if (workingHours[dayOfWeek].includes('Closed')) {
        ...
        if (currentLanguage === 'hebrew') {
            ...
            statusUntilElement.textContent = ' עד 22:00';
        } else if (currentLanguage === 'arabic') {
...
function addToContacts() {
    var contact = {
        name: "شركة الغنى للمواد الغذائية",
        phone: "+972525997061",
        email: "ahmadabuassabeh@gmail.com"
    };
    // create a vcard file
...
function changeLanguage(language, byClickButton = true) {
    ...
    localStorage.setItem('GenaPreferredLanguage', language);
...
function getLanguage() {
    return localStorage.getItem('GenaPreferredLanguage') || 'arabic'; // Default language is Arabic
}
