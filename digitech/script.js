...
function shareOn(type) {
    ...
    const text = 'כרטיס הביקור הדיגטלי של דיגיטק | חנות סלולר ומעבדת תיקונים ';
...
function updateWorkingHoursStatus() {
    ...
    const workingHours = {
        0: 'Closed, Open at 10:00-Monday', // Sunday
        1: currentHour >= 10 && currentHour < 21 ? 'Open until 21:00' : 'Closed, Open at 10:00', // Monday
        2: currentHour >= 10 && currentHour < 21 ? 'Open until 21:00' : 'Closed, Open at 10:00', // Tuesday
        3: currentHour >= 10 && currentHour < 21 ? 'Open until 21:00' : 'Closed, Open at 10:00', // Wednesday
        4: currentHour >= 10 && currentHour < 21 ? 'Open until 21:00' : 'Closed, Open at 13:00', // Thursday
        5: currentHour >= 13 && currentHour < 21 ? 'Open until 21:00' : 'Closed, Open at 10:00', // Friday
        6: currentHour >= 10 && currentHour < 21 ? 'Open until 21:00' : 'Closed, Open at 10:00-Monday', // Saturday
    };
    ...
    if(dayOfWeek==0 || dayOfWeek==6){
        if (currentLanguage === 'hebrew') {
            statusUntilElement.textContent += " יום ב ";
        }
     else if (currentLanguage === 'arabic') {
        statusUntilElement.textContent += " الاثنين "
     }
    }
