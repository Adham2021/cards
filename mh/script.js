...
function updateWorkingHoursStatus() {
    ...
    const workingHours = {
        0: currentHour >= 10 && currentHour < 18 ? 'Open until 18:00' : 'Closed, Open at 10:00', // Sunday
        1: currentHour >= 10 && currentHour < 18 ? 'Open until 18:00' : 'Closed, Open at 10:00', // Monday
        2: currentHour >= 10 && currentHour < 18 ? 'Open until 18:00' : 'Closed, Open at 10:00', // Tuesday
        3: currentHour >= 10 && currentHour < 18 ? 'Open until 18:00' : 'Closed, Open at 10:00', // Wednesday
        4: currentHour >= 10 && currentHour < 18 ? 'Open until 18:00' : 'Closed, Open at 10:00', // Thursday
        5:  'Closed, Open at 10:00-Saturday', // Friday
        6:  currentHour >= 10 && currentHour < 15 ? 'Open until 15:00' : 'Closed, Open at 10:00', // Saturday
    };
...
function addToContacts() {
    var contact = {
        name: "רואה חשבון מוחמד חאג יחיא",
        phone: "+972512966955",
        email: ""
    };
    // create a vcard file
