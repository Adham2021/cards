...
function shareOn(type) {
    ...
    const text = 'الكرت الديجيتالي لصالون أميمة حجازي ابو الهيجا';
...
function updateWorkingHoursStatus() {
    ...
    const workingHours = {
        ...
        5: currentHour >= 8 && currentHour < 20 ? 'Open until 20:00' : 'Closed, Open at 15:00', // Friday
        6: currentHour >= 8 && currentHour < 20 ? 'Open until 20:00' : 'Closed, Open at 08:00', // Saturday
    };
