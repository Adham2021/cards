...
function updateWorkingHoursStatus() {
    ...
    const workingHours = {
        0: currentHour >= 6 && currentHour < 17 ? 'Open until 17:30' : 'Closed, Open at 06:00', // Sunday
        1: currentHour >= 6 && currentHour < 17 ? 'Open until 17:30' : 'Closed, Open at 06:00', // Monday
        2: currentHour >= 6 && currentHour < 17 ? 'Open until 17:30' : 'Closed, Open at 06:00', // Tuesday
        3: currentHour >= 6 && currentHour < 17 ? 'Open until 17:30' : 'Closed, Open at 06:00', // Wednesday
        4: currentHour >= 6 && currentHour < 16 ? 'Open until 17:30' : 'Closed, Open at 06:00', // Thursday
        5: 'Closed, Open at 06:00', // Friday
        6: currentHour >= 6 && currentHour < 16 ? 'Open until 17:30' : 'Closed, Open at 06:00', // Saturday
    };
    ...
    if (workingHours[dayOfWeek].includes('Closed')) {
        if (currentLanguage === 'hebrew') {
            ...
            statusUntilElement.textContent = ' נפתח ב- 06:00';
        } else if (currentLanguage === 'arabic') {
            statusOpenElement.textContent = 'مغلق';
            statusUntilElement.textContent = ' يفتح في الساعة 06:00';
        }
