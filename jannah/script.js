...
function shareOn(type) {
    ...
    const text = 'الكرت الديجيتالي Jannah Accessories | اكسسوارات جنّة" ';
...
function changeLanguage(language, byClickButton = true) {
    ...
    localStorage.setItem('JannahPreferredLanguage', language);
...
function getLanguage() {
    return localStorage.getItem('JannahPreferredLanguage') || 'arabic'; // Default language is Arabic
}
